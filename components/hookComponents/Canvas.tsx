...
import { Dimensions, Image, ImageBackground, Modal, Text, View } from "react-native";
      ...
      <View style={styleCanvas.container}>
         ...
         {!state.signature ?
            ...
            <>
               <View ref={canvasRef} style={{ flex: 1, backgroundColor: 'white' }} collapsable={false}>
                  <ImageBackground
                     style={{ flex: 1 }}
                     source={state.urlImg ? { uri: state.urlImg } : { uri: 'https://it.seaicons.com/wp-content/uploads/2015/07/Homer-Simpson-02-Donut-icon.png' }}
         ...
         <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <Modal
               ...
               onRequestClose={() => setState({ ...state, saveModalVisible: false })}>
               <TouchableOpacity onPress={saveCapture} style={{ padding: 10, backgroundColor: 'blue' }}>
                  <Text>Save me</Text>
               </TouchableOpacity>
            </Modal>
         </View>
